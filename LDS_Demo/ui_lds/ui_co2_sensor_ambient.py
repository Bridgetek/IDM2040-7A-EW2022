...
class ui_co2_sensor_ambient(ui_co2_sensor):
    ...
    def __init__(self, eve: BrtEve, helper: helper, gesture: gesture, layout: layout,LDSBus_Sensor:LDSBus_Sensor):
        ...
        self.title="LDS CO2 Sensor(Ambient)"
    ...
    def processOne(self,lds,eve,x,y):
            ...
            with open(lds_object_file) as lds_json_file:
                ...
                if ui_co2_sensor.data_gui==1:
                    self.circle_box(x =x, y=y, w = 290*2, h = 180*2, border=1, title="Ambient",unit="L", vmin=0, vmax=1000, lwarning=10, hwarning=800, value=self.value_a,tsize=31)
